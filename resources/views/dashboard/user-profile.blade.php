              ...
              <div class="progress-list">
                <div>
                  <div class="progress-row">
                    <span>Visual</span><span>{{ $user->learning_style === 'visual' ? '95%' : '60%' }}</span>
                  </div>
                  <div class="progress-track">
                    <div class="progress-fill progress-primary" style="width: {{ $user->learning_style === 'visual' ? '95%' : '60%' }}"></div>
                  </div>
                </div>
                <div>
                  <div class="progress-row">
                    <span>Diskusi (Auditori)</span><span>{{ $user->learning_style === 'auditory' ? '95%' : '50%' }}</span>
                  </div>
                  <div class="progress-track">
                    <div class="progress-fill progress-secondary" style="width: {{ $user->learning_style === 'auditory' ? '95%' : '50%' }}"></div>
                  </div>
                </div>
                <div>
                  <div class="progress-row">
                    <span>Praktik (Kinestetik)</span><span>{{ $user->learning_style === 'kinesthetic' ? '95%' : '45%' }}</span>
                  </div>
                  <div class="progress-track">
                    <div class="progress-fill progress-tertiary" style="width: {{ $user->learning_style === 'kinesthetic' ? '95%' : '45%' }}"></div>
                  </div>
                </div>
              </div>
