    ...
    <div class="card-left">
      <div class="card-header">
        ...
        <div class="card-actions">
          <button class="btn btn-icon-only btn-ghost fav${s.fav ? " on" : ""}" title="Simpan" onclick="toggleFav(${s.id},this)">
            <span class="material-symbols-outlined">favorite</span>
          </button>
          <button class="btn btn-icon-only btn-ghost" title="Bagikan" onclick="toast('Tautan profil disalin!','success')">
